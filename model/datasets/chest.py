...
from ..utils import gaussianHeatmap, transformer
        ...
        # prefix: '/home/kui/Qikui/landmark/Dataset/chest'
        # sigma: 3
        # num_landmark: 6
        # size: [512, 512] # resize
        # use_abnormal: False
...
global xxx
xxx = ['CHNCXR_0059_0','CHNCXR_0178_0','CHNCXR_0228_0','CHNCXR_0267_0','CHNCXR_0295_0','CHNCXR_0310_0','CHNCXR_0285_0','CHNCXR_0276_0','CHNCXR_0303_0']

class Chest(data.Dataset):

    def __init__(self, prefix='/home/kui/Qikui/landmark/Dataset/chest', phase='train', transform_params=dict(), sigma=3, num_landmark=6, size=[512, 512], use_abnormal=False, chest_set= ['CHN'], exclude_list= xxx,use_background_channel=False):
