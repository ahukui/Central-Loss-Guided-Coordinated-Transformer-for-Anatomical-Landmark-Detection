...
# prefix: '/home/kui/Qikui/landmark/Dataset/hand'
# sigma: 3
# num_landmark: 37
# size: [368, 512] # resize
...
class Hand(data.Dataset):
    ...
    def __init__(self, prefix='/home/kui/Qikui/landmark/Dataset/hand', phase='train', transform_params=dict(), sigma=3, num_landmark=37, size=[368, 512],use_background_channel=False):
